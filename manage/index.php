        ...
        <div class="container mx-auto px-6 max-w-5xl">
            ...
            <div class="flex justify-center items-center gap-4 mt-8">
             ...
             <div class="mt-12 text-center">
                 <a href="<?php echo MANAGE_BACKUP_URL; ?>" class="inline-block bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-gray-700 transition-colors duration-300"><?php echo htmlspecialchars($settings_data['manage_backup_btn']); ?></a>
            </div>
