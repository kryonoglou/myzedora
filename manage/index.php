...
$extensions_icon = '<svg class="w-8 h-8 text-sky-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg>';
    ...
    <section id="manage-dashboard" data-aos="fade-up">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <?php echo create_management_card(MANAGE_PLUGINS_URL, $extensions_icon, htmlspecialchars($settings_data['card_extensions_title']), htmlspecialchars($settings_data['card_extensions_desc'])); ?>
