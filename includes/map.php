...
if ($use_pretty_urls) {
    ...
    define('POST_URL_BASE', $base_url . '/view/post.php?slug=');
    define('PROJECT_URL_BASE', $base_url . '/view/project.php?slug=');
    define('PROJECTS_PAGE_URL', $base_url . '/view/projects.php');
    define('MANAGE_URL', $base_url . '/manage/');
